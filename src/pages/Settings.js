...
const Settings = () => {
  ...
  const { data: followingData } = useFetch("https://api.spotify.com/v1/me/following?type=artist");
      ...
      {!loading ? (
        <article className="relative flex flex-col w-full gap-4 mt-4 text-additional dark:text-white">
          ...
          <div className="flex items-center justify-center flex-col gap-1">
            ...
            <p className="text-xl flex items-center justify-center underline" onClick={() => navigate("/following")}>
